...
This project was originally created by Zero Analyst. I'm following their approach to gain hands-on experience in conducting a data analysis project. In the SQL section below, I've used my own query method, which differs from the original author's approach and can serve as an additional reference.
